...
type ProductCardServiceClient interface {
	AddProductsCards(ctx context.Context, in *AddProductsCardsRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *productCardServiceClient) AddProductsCards(ctx context.Context, in *AddProductsCardsRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type ProductCardServiceServer interface {
	AddProductsCards(context.Context, *AddProductsCardsRequest) (*Empty, error)
...
func (UnimplementedProductCardServiceServer) AddProductsCards(context.Context, *AddProductsCardsRequest) (*Empty, error) {
