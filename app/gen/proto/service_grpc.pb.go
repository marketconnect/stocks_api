...
const (
	...
	ProductCardService_DeleteProductCard_FullMethodName = "/main.ProductCardService/DeleteProductCard"
)
...
func (c *productCardServiceClient) DeleteProductCard(ctx context.Context, in *DeleteProductCardRequest, opts ...grpc.CallOption) (*DeleteProductCardResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProductCardService_DeleteProductCard_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductCardService_DeleteProductCard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductCardService_DeleteProductCard_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
